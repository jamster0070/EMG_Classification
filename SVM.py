...
labels = np.asarray([f'{value}' for value in conf_matrix_svm.flatten()]).reshape(conf_matrix_svm.shape)

plt.figure(figsize=(10, 7))
sns.heatmap(conf_matrix_svm, annot=labels, fmt="", cmap="Blues", xticklabels=le.classes_, yticklabels=le.classes_)
